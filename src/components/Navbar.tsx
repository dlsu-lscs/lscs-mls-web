      ...
      <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-3 px-4 py-2 lg:px-6">
        ...
        <Link href="/" className="flex shrink-0 items-center gap-2.5">
          ...
          <span className="hidden sm:block">
            <span className="block text-[11px] font-semibold uppercase tracking-[0.26em] text-white/45">
              LSCS Planner
            </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <select
                  ...
                  className="cursor-pointer rounded-lg bg-white/10 px-2 py-0.5 text-[13px] font-semibold text-white outline-none transition hover:bg-white/15 disabled:cursor-not-allowed disabled:opacity-50 [&>option]:bg-[#1d3658] [&>option]:text-white"
                >
                  {campuses!.length === 0 ? (
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          {user && (
            <>
              <span className="mx-0.5 hidden h-4 w-px bg-white/15 xl:block" />
              <span className="hidden rounded-lg border border-white/10 bg-white/6 px-2.5 py-1.5 text-[12px] text-white/60 xl:inline">
                {user.email}
              </span>
              <button
                type="button"
                onClick={logout}
                className="rounded-lg bg-[#E8C468] px-3 py-1.5 text-[13px] font-semibold text-[#3D2A08] transition hover:bg-[#f0d17c]"
              >
                Logout
              </button>
            </>
