        ...
        <div className="mx-auto w-full max-w-[1560px] space-y-4">
            ...
            <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-[#4B5563]">
                  Hi {userId}. Compare sections here, use the compact preview for context,
                  then open `Schedule` for the full weekly layout.
                </p>
              </div>
          ...
          <div className="grid w-full items-start justify-center gap-5 lg:grid-cols-[minmax(0,6fr)_minmax(360px,4fr)]">
            <section className="w-full space-y-4">
              <div className="w-full rounded-2xl border border-[#E5E7EB] bg-white p-5">
                  ...
                  <table className="w-full table-fixed border-collapse text-left">
                    <thead className="bg-[#5C6B80] text-white">
                      <tr className="text-left text-[12px] font-semibold">
                        ...
                        <th className="w-[148px] px-3 py-2 sm:px-4 sm:py-3">Remarks / Modality</th>
                    ...
                    <tbody>
                      {filteredCourses.map((course) => {
                        ...
                        return (
                          <tr key={course.id} className="border-t border-[#E5E7EB] text-[12px] text-[#4B5563] align-top">
                            ...
                            <td className="px-3 py-2 sm:px-4 sm:py-3 font-semibold text-[#111827] whitespace-normal break-words">{course.code}</td>
                            <td className="px-3 py-2 sm:px-4 sm:py-3">
                            ...
                            <td className="px-3 py-2 sm:px-4 sm:py-3 whitespace-normal break-words leading-tight">{course.professor}</td>
                            <td className="px-3 py-2 sm:px-4 sm:py-3 whitespace-normal break-words leading-tight">
                              ...
                              <p className="mt-0.5 text-[11px] text-[#64748B]">{course.remarks}</p>
                            </td>
                            <td className="px-3 py-2 sm:px-4 sm:py-3 whitespace-normal break-words leading-tight">{meetingTimeLabel(course.meetings)}</td>
                            <td className="px-3 py-2 sm:px-4 sm:py-3 whitespace-normal">{meetingDaysLabel(course.meetings)}</td>
                            <td className="px-3 py-2 sm:px-4 sm:py-3 whitespace-normal break-words leading-tight">{meetingRoomLabel(course.meetings)}</td>
